...
impl Opcode {
    ...
    pub fn from_u16(n: u16) -> Option<Self> {
        match n {
            1 => Some(Self::OP2_1), 2 => Some(Self::OP2_2), 3 => Some(Self::OP2_3), 4 => Some(Self::OP2_4),
            5 => Some(Self::OP2_5), 6 => Some(Self::OP2_6), 7 => Some(Self::OP2_7), 8 => Some(Self::OP2_8),
            9 => Some(Self::OP2_9), 10 => Some(Self::OP2_10), 11 => Some(Self::OP2_11), 12 => Some(Self::OP2_12),
            13 => Some(Self::OP2_13), 14 => Some(Self::OP2_14), 15 => Some(Self::OP2_15), 16 => Some(Self::OP2_16),
            17 => Some(Self::OP2_17), 18 => Some(Self::OP2_18), 19 => Some(Self::OP2_19), 20 => Some(Self::OP2_20),
            21 => Some(Self::OP2_21), 22 => Some(Self::OP2_22), 23 => Some(Self::OP2_23), 24 => Some(Self::OP2_24),
            25 => Some(Self::OP2_25), 26 => Some(Self::OP2_26), 27 => Some(Self::OP2_27), 28 => Some(Self::OP2_28),
            128 => Some(Self::OP1_128), 129 => Some(Self::OP1_129), 130 => Some(Self::OP1_130), 131 => Some(Self::OP1_131),
            132 => Some(Self::OP1_132), 133 => Some(Self::OP1_133), 134 => Some(Self::OP1_134), 135 => Some(Self::OP1_135),
            136 => Some(Self::OP1_136), 137 => Some(Self::OP1_137), 138 => Some(Self::OP1_138), 139 => Some(Self::OP1_139),
            140 => Some(Self::OP1_140), 141 => Some(Self::OP1_141), 142 => Some(Self::OP1_142), 143 => Some(Self::OP1_143),
            176 => Some(Self::OP0_176), 177 => Some(Self::OP0_177), 178 => Some(Self::OP0_178), 179 => Some(Self::OP0_179),
            180 => Some(Self::OP0_180), 181 => Some(Self::OP0_181), 182 => Some(Self::OP0_182), 183 => Some(Self::OP0_183),
            184 => Some(Self::OP0_184), 185 => Some(Self::OP0_185), 186 => Some(Self::OP0_186), 187 => Some(Self::OP0_187),
            188 => Some(Self::OP0_188), 189 => Some(Self::OP0_189), 191 => Some(Self::OP0_191),
            224 => Some(Self::VAR_224), 225 => Some(Self::VAR_225), 226 => Some(Self::VAR_226), 227 => Some(Self::VAR_227),
            228 => Some(Self::VAR_228), 229 => Some(Self::VAR_229), 230 => Some(Self::VAR_230), 231 => Some(Self::VAR_231),
            232 => Some(Self::VAR_232), 233 => Some(Self::VAR_233), 234 => Some(Self::VAR_234), 235 => Some(Self::VAR_235),
            236 => Some(Self::VAR_236), 237 => Some(Self::VAR_237), 238 => Some(Self::VAR_238), 239 => Some(Self::VAR_239),
            240 => Some(Self::VAR_240), 241 => Some(Self::VAR_241), 242 => Some(Self::VAR_242), 243 => Some(Self::VAR_243),
            244 => Some(Self::VAR_244), 245 => Some(Self::VAR_245), 246 => Some(Self::VAR_246), 247 => Some(Self::VAR_247),
            248 => Some(Self::VAR_248), 249 => Some(Self::VAR_249), 250 => Some(Self::VAR_250), 251 => Some(Self::VAR_251),
            252 => Some(Self::VAR_252), 253 => Some(Self::VAR_253), 254 => Some(Self::VAR_254), 255 => Some(Self::VAR_255),
            1000 => Some(Self::EXT_1000), 1001 => Some(Self::EXT_1001), 1002 => Some(Self::EXT_1002), 1003 => Some(Self::EXT_1003),
            1004 => Some(Self::EXT_1004), 1005 => Some(Self::EXT_1005), 1006 => Some(Self::EXT_1006), 1007 => Some(Self::EXT_1007),
            1008 => Some(Self::EXT_1008), 1009 => Some(Self::EXT_1009), 1010 => Some(Self::EXT_1010), 1011 => Some(Self::EXT_1011),
            1012 => Some(Self::EXT_1012), 1013 => Some(Self::EXT_1013), 1016 => Some(Self::EXT_1016), 1017 => Some(Self::EXT_1017),
            1018 => Some(Self::EXT_1018), 1019 => Some(Self::EXT_1019), 1020 => Some(Self::EXT_1020), 1021 => Some(Self::EXT_1021),
            1022 => Some(Self::EXT_1022), 1023 => Some(Self::EXT_1023), 1024 => Some(Self::EXT_1024), 1025 => Some(Self::EXT_1025),
            1026 => Some(Self::EXT_1026), 1027 => Some(Self::EXT_1027), 1028 => Some(Self::EXT_1028), 1029 => Some(Self::EXT_1029),
            _ => None,
        }
    }
}
